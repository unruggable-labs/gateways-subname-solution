  ...
  useEffect(() => {
    const validateResolver = async () => {
      ...
      try {
        ...
        addLog(`Resolver found at ${resolver}. (${l1ChainConfig.etherscan.browserUrl}/address/${resolver})`);
        ...
        addLog(`Profile storage address: ${profileStorageAddress}. (${chainConfig?.etherscan.browserUrl}/address/${profileStorageAddress})`);
